import Profile from '../../assets/images/profile/lembawe9.png';
            ...
            <section className='main main-section' id='home'>
                <div className="main-container section-content">
                            ...
                            <div className='title-description-container'>
                                <div className='main-title'>
                                    <h1 style={{ paddingTop: '5rem', margin: 'auto 0', fontWeight: 'normal' }}>
                                        Hi, I'm <span>Lembawe9</span>
                                    </h1>
                                    <h3 style={{fontWeight: 'bold' }}>
                                        <span>a Moroccan<br/></span> 
                                        <span>
                                            <Typewriter
                                                loop
                                                cursor
                                                ...
                                                deleteSpeed={50}
                                                delaySpeed={1000}
                                                words={['Musical artist', 'Youtuber', 'Influencer']}
                                            />
                                        </span>
                                    </h3>
                                </div>
                    ...
                    <div className="social-media-container">
                        ...
                        <li>
                            <a href="nstagram.com/lembawe9" target="_blank" rel='noreferrer'>
                                <div className="bg__icon">
